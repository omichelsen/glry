...
module.exports = function Glry(options) {
	...
	if (elmNavigation) {
		...
		elmNavigation
			.querySelector('.prev')
			.addEventListener('tap', handleNavigationClick.bind(this, 'left'));
		elmNavigation
			.querySelector('.next')
			.addEventListener('tap', handleNavigationClick.bind(this, 'right'));
	}
